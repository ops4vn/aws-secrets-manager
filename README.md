...
**Phiên bản mới nhất: v0.0.22**

- **macOS (Apple Silicon)**: [Tải Secrets Manager 0.0.22 (aarch64)](https://secrets-manager.ledangdung.com/releases/darwin/aarch64/0.0.22/Secrets%20Manager.app.tar.gz)
- **Windows (x86_64)**: [Tải Secrets Manager 0.0.22 (x64)](https://secrets-manager.ledangdung.com/releases/windows/x86_64/0.0.22/Secrets%20Manager_0.0.22_x64_en-US.msi)
- **Linux (x86_64)**: [Tải Secrets Manager 0.0.22 (AppImage)](https://secrets-manager.ledangdung.com/releases/linux/x86_64/0.0.22/secrets-manager_0.0.22_amd64.AppImage)
